...
<div class="setting-group">
    ...
    <div class="setting-items">
        ...
        <SettingContainer name={"Chat Name"} desc={"Default Name for new chat"}>
            <Text
                ...
                blurFunc={(value: string) =>
                    (pluginData.defaultChatName = value)}
            />
        </SettingContainer>
        ...
        <SettingContainer
            ...
            desc={"Choose the Model that will be selected by default on *new chats*"}
        >
            <DropdownComp />
        </SettingContainer>
    </div>
...
<!-- RAG Settings -->
<SettingContainer isHeading={true} name="RAG Settings" />
...
>
    <select
        ...
        onchange={(e) => handleSearchAlgorithmChange(e.currentTarget.value as SearchAlgorithm)}
    >
...
<!-- Debugging Settings -->
<details>
    <summary class="setting-item-heading">Debugging</summary>

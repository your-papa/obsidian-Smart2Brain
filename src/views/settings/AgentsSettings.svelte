<script lang="ts">
  ...
  const TOOLS: ToolInfo[] = [
    ...
    },
    {
      ...
      defaultDescription:
        "Delete a markdown note from the vault. Changes are staged for user approval before being applied.",
    },
    {
      id: "edit_note",
      defaultName: "Edit Note",
      defaultDescription:
        "Make targeted search-and-replace edits to an existing markdown note. Changes are staged for user approval before being applied.",
    },
  ];

 ...
 * icon via `skillIcon`.
 */
export const BUNDLED_CORE_SKILL_ICONS: Record<string, string> = {
	"explore-vault": "compass",
	"edit-notes": "file-pen",
	web: "globe",
	"update-skills": "wand-2",
};
 ...
 */
export const S2B_CORE_SKILL_ORDER = ["explore-vault", "edit-notes", "web", "update-skills"];

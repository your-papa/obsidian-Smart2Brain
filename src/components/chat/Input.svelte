      ...
      <div class="ml-auto flex items-center gap-2">
        ...
        {#if !messenger.session || messenger.session.messageState === MessageState.idle}
          <Button
            ...
            styles="h-7 w-7 p-1 rounded-md !bg-text-accent border-none cursor-pointer flex items-center justify-center shrink-0 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-[--text-on-accent]"
